  ...
  return (
    <div className='object-cover bg-gradient-to-t h-480 w-960'>
      ...
      <div className='space-y-10 py-20 flex flex-col justify-center px-5 lg:px-10'>
        <h1>NEW ARRIVALS</h1><HomeSectionCarousel data={womenTopsData} />
        <h1>WOMEN</h1><HomeSectionCarousel />
        <h1>MEN</h1><HomeSectionCarousel />
        <h1>ACCESSORIES</h1><HomeSectionCarousel />
        <h1>SKINCARE</h1><HomeSectionCarousel />
        <h1>ELECTRONICS</h1><HomeSectionCarousel />
      </div>
