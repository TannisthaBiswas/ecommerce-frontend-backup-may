        ...
        <section className='grid grid-cols-3  gap-y-10 px-4 pt-10' >
          ...
          <div className="lg:col-span-1 col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-3xl font-semibold text-gray-900">{product.product?.title}</h1>
              <h1 className="text-lg lg:text-xl text-gray-900 opcity-60 pt-1">{product.product?.brand}</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                ...
                <p className="text-green-600 font-semibold">
                  {Math.ceil((product.product?.price-product.product?.discountedPrice)/product.product?.price*100)}% Off
                </p>
              </div>
              {/* Reviews */}
              <div className="mt-6">
