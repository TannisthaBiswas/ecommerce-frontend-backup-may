...
const handleAddToCart=(e)=>{
  const data = {productId:params.product._id,size:params.size};
 // e.preventDefault();
        ...
        <section className='grid grid-cols-3  gap-y-10 px-4 pt-10' >
          ...
          <div className="lg:col-span-1 col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-3xl font-semibold text-gray-900">{products.product?.title}</h1>
              <h1 className="text-lg lg:text-xl text-gray-900 opcity-60 pt-1">{products.product?.brand}</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                ...
                <p className="text-green-600 font-semibold">
                  {Math.ceil((products.product?.price-products.product?.discountedPrice)/products.product?.price*100)}% Off
                </p>
              </div>
              {/* Reviews */}
              <div className="mt-6">
...
{/* rating overview section */}              
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3 pb-10">
                  ...
                  <p className="opacity-60">4567 Ratings</p>
                </div>
                <Box className="mt-5">
                  <Grid
                    container
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">890</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">1234</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">567</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">78</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
