...
{/* My Grid Section */}
<section className='grid grid-rows-2 gap-y-10 px-4 pt-10' >


        {/* Image gallery */}
        <div className="flex flex-col row-span-2 items-center">
        ...
        {/* Product info */}
        <div className="row-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
