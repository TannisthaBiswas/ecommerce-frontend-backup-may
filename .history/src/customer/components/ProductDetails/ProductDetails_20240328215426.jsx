...
{/* My Grid Section */}
<section className='grid grid-cols-3 lg:grid-cols-3 gap-y-10 px-4 pt-10' >
        ...
        {/* Product info */}
        <div className="col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
