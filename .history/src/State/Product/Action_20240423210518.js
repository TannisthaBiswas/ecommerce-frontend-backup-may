...
export const findProducts = (reqData) => async (dispatch) => {
  ...
  try {
    const { data } = await api.get(`/api/products?category=${category}&color=${color}&sizes=${sizes}&pageNumber=${pageNumber}&pageSize=${pageSize}`);
    //&size=${sizes}&minPrice=${minPrice}&minDiscount=${minDiscount}&sort=${sort}&stock=${stock}&pageSize=${pageSize}
